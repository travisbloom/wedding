...
export class AnimatedLogo extends React.Component<
  RouteComponentProps<any> & { isOnHomepage: boolean },
...
> {
  ...
  render() {
    ...
    const interpolator = interpolate(
      this.state.prevPath ? paths[this.state.prevPath] : pathSVG,
      pathSVG,
      {
    ...
    return (
      <svg width="30" height="20">
        <g
          ...
          fillRule="evenodd"
          fontSize="9pt"
          stroke={isOnHomepage ? theme.colors.white : theme.colors.black}
          fill="none"
          style={{
            stroke: isOnHomepage ? theme.colors.white : theme.colors.black,
            fill: "none",
